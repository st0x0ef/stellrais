...
public class TabletMainScreen extends AbstractContainerScreen<TabletMenu> {
    ...
    private final ResourceLocation BACKGROUND = ResourceLocation.fromNamespaceAndPath(Stellaris.MODID, "textures/gui/tablet/tablet_background.png");
    public static ArrayList<TabletEntries> ENTRIES = new ArrayList<>();
    ...
    protected void init() {
        ...
        ENTRIES.forEach((entry) -> {
            ...
            //Stellaris.LOG.info("Added button to screen: " + column);
            Stellaris.LOG.info("Added button to screen: " + row);
